...
#define NEXT_QUIET_FLAG			(1 << 3)
#define NEXT_MAKEFILES_FLAG		(1 << 4)
#define NEXT_FINDFILE_FLAG		(1 << 6)
#define NEXT_CARET_FLAG			(1 << 7)
#define NEXT_DEFAULT_FLAGS		(NEXT_VPATH_FLAG | 	\
					 NEXT_FINDFILE_FLAG |	\
					 NEXT_QUIET_FLAG | 	\
					 NEXT_MAKEFILES_FLAG |	\
					 NEXT_CARET_FLAG)
