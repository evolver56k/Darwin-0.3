 ...
 *
 * DualEide.h - Dual EIDE controller initialization methods. 
 *
...
__private_extern__ unsigned int	instanceNum;
__private_extern__ BOOL         dualEide;

@interface DualEide:IODirectDevice
