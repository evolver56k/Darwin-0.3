 ...
 * HISTORY
 *
 * 5-Jan-1998	Joe Liu at Apple
 *	Added fields in atapiIoReq_t for SCSI/ATAPI command conversion.
 *
 * 1-Sep-1994	Rakesh Dubey at NeXT
 *	Created.
 */

#ifndef _ATAPI_CNT_CMDS_H
#define _ATAPI_CNT_CMDS_H 1
