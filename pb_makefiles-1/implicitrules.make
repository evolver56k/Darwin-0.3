...
.SUFFIXES: .h .c .m .cc .cxx .cpp .C .M .s .i386.o .m68k.o .sparc.o .ppc.o .o
...
ifeq "$(NUM_ARCHS)" "1"
	$(SILENT) $(RM) -f $(OFILE_DIR)/$(notdir $*).o
	$(SILENT) $(SYMLINK) $(OFILE_DIR)/$(notdir $*).$(ADJUSTED_TARGET_ARCHS).o $(OFILE_DIR)/$(notdir $*).o
else
