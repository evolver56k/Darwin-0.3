...
SRCFILES = PB.project $(JAVA_CLASSES) $(JAVA_CLASSES_CLIENT) $(OTHERSRCS) $(HFILES) $(CLASSES) $(MFILES) $(CFILES) $(CAPCFILES) $(CAPMFILES) $(CCFILES) $(CPPFILES) $(CXXFILES) $(YFILES) $(LFILES) $(PSWFILES) $(PSWMFILES) $(WOSFILES) $(foreach L,$(LANGUAGES),$(addprefix $(L).lproj/,$($(L)_RESOURCES))) $(GLOBAL_RESOURCES) $(foreach L,$(LANGUAGES),$(addprefix $(L).lproj/,$($(L)_HELP_FILES))) $(OTHERLINKED) $(OTHER_SOURCEFILES)
