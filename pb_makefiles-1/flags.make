...
PB_CFLAGS += $($(OS)_PB_CFLAGS)
PB_MFLAGS += $($(OS)_PB_MFLAGS)
PB_CCFLAGS += $($(OS)_PB_CCFLAGS)
PB_MMFLAGS += $($(OS)_PB_MMFLAGS)
PB_PRECOMPFLAGS += $($(OS)_PRECOMPFLAGS)
PB_LDFLAGS += $($(OS)_PB_LDFLAGS)
PB_PSWFLAGS += $($(OS)_PB_PSWFLAGS)
PB_RPCFLAGS += $($(OS)_PB_RPCFLAGS)
PB_YFLAGS += $($(OS)_PB_YFLAGS)
PB_LFLAGS += $($(OS)_PB_LFLAGS)
