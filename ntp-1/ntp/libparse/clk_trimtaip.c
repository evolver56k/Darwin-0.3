/*
 * $Header: /cvs/Darwin/CoreOS/Services/ntp/ntp/libparse/clk_trimtaip.c,v 1.1.1.2 1999/04/23 01:23:18 wsanchez Exp $
 *
 * $Id: clk_trimtaip.c,v 1.1.1.2 1999/04/23 01:23:18 wsanchez Exp $
 *
