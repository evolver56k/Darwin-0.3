/*
 * $Header: /cvs/Darwin/CoreOS/Services/ntp/ntp/libparse/clk_schmid.c,v 1.1.1.2 1999/04/23 01:23:17 wsanchez Exp $
 *  
 * $Id: clk_schmid.c,v 1.1.1.2 1999/04/23 01:23:17 wsanchez Exp $
 *
