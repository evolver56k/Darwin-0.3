...
fetchMailbox:
    ...
    move SCRATCHA0 to SFBR                  ; if non-zero, have implicit semaphore
    move SCRATCHA1 | SFBR to SFBR
...
AbortMailbox:
    ...
    load  SCRATCHB0, 4, ld_zeroes               ; clear  Scratch B
    load  SCRATCHB2, 1, ld_AbortBdr_mailbox+2   ; get SCSI ID
    store SCRATCHB0, 4, AbortSelect+4           ; *** Patch the Select/ATN instruction
