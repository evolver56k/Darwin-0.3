...
_stub_binding_helper_interface:
	...
	stw	r2,20(r1)	; save r2 (toc) in the linkage area
	stw	r0,8(r1)	; save link register value in the linkage area
	stwu	r1,-64(r1)	; save stack pointer and update it
	mr	r31,r1		; set new frame pointer from stack pointer

	stw	r3,88(r1)	; save all registers that could contain
	stw	r4,92(r1)	;  parameters to the routine that is being
	stw	r5,96(r1)	;  bound.
	stw	r6,100(r1)
	stw	r7,104(r1)
	stw	r8,108(r1)
	...
	lwz	r10,116(r1)	; restore all registers that could contain
	lwz	r9,112(r1)	;  parameters to the routine that was bound.
	lwz	r8,108(r1)
	lwz	r7,104(r1)
	lwz	r6,100(r1)
	lwz	r5,96(r1)
	...
	addi	r1,r1,64	; restore old stack pointer
	lwz	r0,8(r1)	; get old link register value
	mtlr	r0		; restore link register
	lwz	r2,20(r1)	; restore r2 (toc) from the linkage area
