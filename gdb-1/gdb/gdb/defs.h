...
extern void init_mmalloc_default_pool PARAMS ((void *));
...
extern char *skip_quoted PARAMS ((char *, char *));
...
extern NORETURN void fatal_dump_core PARAMS ((char *string, ...)) ATTR_NORETURN;
...
void (*call_command_hook) 
  PARAMS ((struct cmd_list_element *c, char *cmd, int from_tty));

/* called in place of printing a source line */
void (*print_source_lines_hook)
