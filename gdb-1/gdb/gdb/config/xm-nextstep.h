...
extern void next_resize_window_handler PARAMS ((int signal));
extern void next_resize_window PARAMS ((int *width, int *height));
...
extern void xfree PARAMS ((void *v));
extern void xmfree PARAMS ((void *md, void *v));
