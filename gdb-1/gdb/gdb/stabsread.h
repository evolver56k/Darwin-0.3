...
define_symbol PARAMS ((CORE_ADDR, char *, char *, int, int, struct objfile *));
...
start_psymtab PARAMS ((struct objfile *, struct section_offsets *, char *,
		       ...
		       struct partial_symbol **, const char *));
...
extern void
process_one_symbol PARAMS ((int, int, CORE_ADDR, char *, const char *,
...
extern char *stabsread_objc_colon PARAMS ((char *name));
