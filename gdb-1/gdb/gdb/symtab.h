...
extern struct minimal_symbol *
lookup_minimal_symbol_by_pc_section_objfile PARAMS ((CORE_ADDR, asection *, struct objfile *));
...
symbol_file_add PARAMS ((const char *, int, CORE_ADDR, int, int, int, CORE_ADDR, int, int, int, const char *));

extern struct objfile *
symbol_file_add_bfd PARAMS ((bfd *, int, CORE_ADDR, int, int, int, CORE_ADDR, int, int, int, const char *));
