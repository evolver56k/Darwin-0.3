...
static void
info_tasks_command(char* args, int from_tty)
{
    int	sysControl[4];
    int	count, index;
    size_t length;
...
static void
info_ports_command(char* args, int from_tty)
{
...
static void
info_port_command (char* args, int from_tty)
{
    task_t task;
    port_t port;
...
static void
info_threads_command(char* args, int from_tty)
{
...
static void
info_thread_command(char* args, int from_tty)
{
    union {
...
void info_regions_command (char *exp, int from_tty)
{
...
void info_region_command (char *exp, int from_tty)
{
...
void _initialize_next_info_commands (void)
{
  add_info ("mach-tasks", info_tasks_command, "Get list of tasks in system.");
  add_info ("mach-ports", info_ports_command, "Get list of ports in a task.");
  add_info ("mach-port", info_port_command, "Get info on a specific port.");
  add_info ("mach-task", info_task_command, "Get info on a specific task.");
  add_info ("mach-threads", info_threads_command, "Get list of threads in a task.");
  add_info ("mach-thread", info_thread_command, "Get info on a specific thread.");

  add_info ("mach-regions", info_regions_command, "Get information on all mach region for the current inferior.");
  add_info ("mach-region", info_region_command, "Get information on mach region at given address.");
}
