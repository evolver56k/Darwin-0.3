...
#define FRT FRS
  ...
  /* The VA field in an AltiVec instruction.  */
#define VRA FRS + 1
  { 5, 16, 0, 0, PPC_OPERAND_VR },

  /* The VB field in an AltiVec instruction.  */
#define VRB VRA + 1
  { 5, 11, 0, 0, PPC_OPERAND_VR },

  /* The VC field in an AltiVec instruction.  */
#define VRC VRB + 1
  { 5, 6, 0, 0, PPC_OPERAND_VR },

  /* The VD field in an AltiVec instruction.  */
#define VRD VRC + 1
  { 5, 21, 0, 0, PPC_OPERAND_VR },

  /* The UI field in an AltiVec instruction.  */
#define VUI VRD + 1
  { 5, 16, 0, 0, 0 },

  /* The SI field in an AltiVec instruction.  */
#define VSI VUI + 1
  { 5, 16, 0, 0, PPC_OPERAND_SIGNED },

  /* The SH field in an AltiVec instruction.  */
#define VSH VSI + 1
  { 4, 6, 0, 0, 0 },

  /* The STRM field in an AltiVec instruction.  */
#define STRM VSH + 1
  { 2, 21, 0, 0, 0 },
...
#define AV(avop) (0x10000000 | ((avop) & 0x7ff))

/* An AltiVec instruction with the VC field included.  */
#define AVC(avop) (0x10000000 | ((avop) & 0x3f))

/* An AltiVec instruction with the RC bit specified.  */
#define AVRC(avop, rc) (0x10000000 | ((avop) & 0x3ff) | (((rc) & 1) << 10))

/* An AltiVec memory instruction (major code 31).  */
#define AV31(avop) (0x7c000000 | (((avop) & 0x3ff) << 1))
#define AV31D(avop,a) (0x7c000000 | (((a) & 1) << 25) | (((avop) & 0x3ff) << 1))

/* AltiVec instruction masks.  */
#define AV_MASK (0xfc0007ff)
#define AVC_MASK (0xfc00003f)
#define AVD_MASK (0xfe0007fe)
...
#define	ALTIVEC	PPC_OPCODE_POWER | PPC_OPCODE_PPC | PPC_OPCODE_COMMON | PPC_OPCODE_ANY

/* The opcode table.
...
{ "mfvscr",    AV(1540),     AV_MASK,	ALTIVEC,	{ VRD } },
{ "mtvscr",    AV(1604),     AV_MASK,	ALTIVEC,	{ VRB } },
{ "vaddcuw",   AV(384),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vaddfp",    AV(10),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vaddsbs",   AV(768),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vaddshs",   AV(832),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vaddsws",   AV(896),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vaddubm",   AV(0),        AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vaddubs",   AV(512),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vadduhm",   AV(64),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vadduhs",   AV(576),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vadduwm",   AV(128),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vadduws",   AV(640),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vand",      AV(1028),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vandc",     AV(1092),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vavgsb",    AV(1282),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vavgsh",    AV(1346),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vavgsw",    AV(1410),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vavgub",    AV(1026),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vavguh",    AV(1090),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vavguw",    AV(1154),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcfsx",     AV(842),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vcfux",     AV(778),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vcmpbfp",   AVRC(966,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpbfp.",  AVRC(966,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpeqfp",  AVRC(198,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpeqfp.", AVRC(198,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpequb",  AVRC(6,0),    AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpequb.", AVRC(6,1),    AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpequh",  AVRC(70,0),   AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpequh.", AVRC(70,1),   AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpequw",  AVRC(134,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpequw.", AVRC(134,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgefp",  AVRC(454,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgefp.", AVRC(454,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtfp",  AVRC(710,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtfp.", AVRC(710,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtsb",  AVRC(774,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtsb.", AVRC(774,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtsh",  AVRC(838,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtsh.", AVRC(838,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtsw",  AVRC(902,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtsw.", AVRC(902,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtub",  AVRC(518,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtub.", AVRC(518,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtuh",  AVRC(582,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtuh.", AVRC(582,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtuw",  AVRC(646,0),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vcmpgtuw.", AVRC(646,1),  AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vctsxs",    AV(970),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vctuxs",    AV(906),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vexptefp",  AV(426),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vlogefp",   AV(458),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vmaddfp",   AVC(46),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRC, VRB } },
{ "vmaxfp",    AV(1034),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmaxsb",    AV(258),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmaxsh",    AV(322),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmaxsw",    AV(386),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmaxub",    AV(2),        AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmaxuh",    AV(66),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmaxuw",    AV(130),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmhaddshs", AVC(32),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmhraddshs",AVC(33),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vminfp",    AV(1098),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vminsb",    AV(770),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vminsh",    AV(834),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vminsw",    AV(898),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vminub",    AV(514),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vminuh",    AV(578),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vminuw",    AV(642),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmladduhm", AVC(34),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmrghb",    AV(12),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmrghh",    AV(76),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmrghw",    AV(140),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmrglb",    AV(268),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmrglh",    AV(332),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmrglw",    AV(396),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmsummbm",  AVC(37),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmsumshm",  AVC(40),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmsumshs",  AVC(41),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmsumubm",  AVC(36),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmsumuhm",  AVC(38),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmsumuhs",  AVC(39),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vmulesb",   AV(776),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmulesh",   AV(840),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmuleub",   AV(520),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmuleuh",   AV(584),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmulosb",   AV(264),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmulosh",   AV(328),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmuloub",   AV(8),        AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vmulouh",   AV(72),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vnmsubfp",  AVC(47),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRC, VRB } },
{ "vnor",      AV(1284),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vor",       AV(1156),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vperm",     AVC(43),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vpkpx",     AV(782),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkshss",   AV(398),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkshus",   AV(270),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkswss",   AV(462),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkswus",   AV(334),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkuhum",   AV(14),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkuhus",   AV(142),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkuwum",   AV(78),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vpkuwus",   AV(206),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vrefp",     AV(266),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vrfim",     AV(714),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vrfin",     AV(522),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vrfip",     AV(650),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vrfiz",     AV(586),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vrlb",      AV(4),        AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vrlh",      AV(68),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vrlw",      AV(132),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vrsqrtefp", AV(330),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vsel",      AVC(42),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VRC } },
{ "vsl",       AV(452),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vslb",      AV(260),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsldoi",    AVC(44),      AVC_MASK,	ALTIVEC,	{ VRD, VRA, VRB, VSH } },
{ "vslh",      AV(324),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vslo",      AV(1036),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vslw",      AV(388),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vspltb",    AV(524),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vsplth",    AV(588),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vspltisb",  AV(780),      AV_MASK,	ALTIVEC,	{ VRD, VSI } },
{ "vspltish",  AV(844),      AV_MASK,	ALTIVEC,	{ VRD, VSI } },
{ "vspltisw",  AV(908),      AV_MASK,	ALTIVEC,	{ VRD, VSI } },
{ "vspltw",    AV(652),      AV_MASK,	ALTIVEC,	{ VRD, VRB, VUI } },
{ "vsr",       AV(708),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsrab",     AV(772),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsrah",     AV(836),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsraw",     AV(900),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsrb",      AV(516),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsrh",      AV(580),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsro",      AV(1100),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsrw",      AV(644),      AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubcuw",   AV(1408),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubfp",    AV(74),       AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubsbs",   AV(1792),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubshs",   AV(1856),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubsws",   AV(1920),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsububm",   AV(1024),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsububs",   AV(1536),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubuhm",   AV(1088),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubuhs",   AV(1600),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubuwm",   AV(1152),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsubuws",   AV(1664),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsumsws",   AV(1928),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsum2sws",  AV(1672),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsum4sbs",  AV(1800),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsum4shs",  AV(1608),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vsum4ubs",  AV(1544),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
{ "vupkhpx",   AV(846),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vupkhsb",   AV(526),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vupkhsh",   AV(590),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vupklpx",   AV(974),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vupklsb",   AV(654),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vupklsh",   AV(718),      AV_MASK,	ALTIVEC,	{ VRD, VRB } },
{ "vxor",      AV(1220),     AV_MASK,	ALTIVEC,	{ VRD, VRA, VRB } },
...
{ "dss",       AV31D(822,0), AVD_MASK,	ALTIVEC,   	{ STRM } },
{ "dssall",    AV31D(822,1), AVD_MASK,	ALTIVEC,   	{ STRM } },
{ "dst",       AV31D(342,0), AVD_MASK,	ALTIVEC,   	{ RA, RB, STRM } },
{ "dstt",      AV31D(342,1), AVD_MASK,	ALTIVEC,   	{ RA, RB, STRM } },
{ "dstst",     AV31D(374,0), AVD_MASK,	ALTIVEC,   	{ RA, RB, STRM } },
{ "dststt",    AV31D(374,1), AVD_MASK,	ALTIVEC,   	{ RA, RB, STRM } },
{ "lvebx",     AV31(7),      AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "lvehx",     AV31(39),     AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "lvewx",     AV31(71),     AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "lvsl",      AV31(6),      AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "lvsr",      AV31(38),     AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "lvx",       AV31(103),    AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "lvxl",      AV31(359),    AV_MASK,	ALTIVEC,   	{ VRD, RA, RB } },
{ "stvebx",    AV31(135),    AV_MASK,	ALTIVEC,	{ VRD, RA, RB } },
{ "stvehx",    AV31(167),    AV_MASK,	ALTIVEC,	{ VRD, RA, RB } },
{ "stvewx",    AV31(199),    AV_MASK,	ALTIVEC,	{ VRD, RA, RB } },
{ "stvx",      AV31(231),    AV_MASK,	ALTIVEC,	{ VRD, RA, RB } },
{ "stvxl",     AV31(487),    AV_MASK,	ALTIVEC,	{ VRD, RA, RB } },
