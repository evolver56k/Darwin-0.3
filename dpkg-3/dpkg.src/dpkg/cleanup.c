...
void cu_prermupgrade(int argc, void **argv) {
  ...
  maintainer_script_installed(pkg,POSTINSTFILE,_("post-installation"),
                              "abort-upgrade",
...
void cu_prermdeconfigure(int argc, void **argv) {
  ...
  /* submsg: maintainer_script_installed */
  maintainer_script_installed(deconf,POSTINSTFILE,_("post-installation"),
...
void cu_prerminfavour(int argc, void **argv) {
  ...
  /* submsg: maintainer_script_installed */
  maintainer_script_installed(conflictor,POSTINSTFILE,_("post-installation"),
...
void cu_preinstverynew(int argc, void **argv) {
  ...
  maintainer_script_new(POSTRMFILE,_("post-removal"),cidir,cidirrest,
...
void cu_postrmupgrade(int argc, void **argv) {
  ...
  if (cleanup_pkg_failed++) return;
  /* submsg: maintainer_script_installed */
  maintainer_script_installed(pkg,PREINSTFILE,_("pre-installation"),
