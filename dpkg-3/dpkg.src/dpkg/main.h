...
enum action { act_unset, act_install, act_unpack, act_avail, act_configure,
              ...
              act_assertpredep, act_predeppackage, act_cmpversions,
	      act_printarch, act_printinstarch, act_printgnubuildarch, 
	      act_printgnuinstarch, act_printgnutargetarch,
              act_compareversions, act_printavail, act_avclear,
...
void forcibleerr(int forceflag, const char *format, ...) __attribute__ ((format (printf, 2, 3)));
...
void debug(int which, const char *fmt, ...) __attribute__ ((format (printf, 2, 3)));
