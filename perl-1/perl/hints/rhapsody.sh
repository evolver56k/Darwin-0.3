...
netlib='/Network/Library/Perl';
netlibexp="${netlib}";
netarch="/Network/Library/Perl/${archname}";
netarchexp="${netarch}";
installnetlib="${netlib}";
installnetlibexp="${netlib}";
installnetarch="${netarch}"
installnetarchexp="${netarch}";

# Who's fault is this?
cf_email='wsanchez@apple.com';
perladmin='support@apple.com';
