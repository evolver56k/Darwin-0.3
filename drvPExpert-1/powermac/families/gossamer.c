...
powermac_init_t gossamer_init = {
	configure_gossamer,		// configure_machine
...
#define NGOSSAMER_VIA1_INTERRUPTS 7

struct powermac_interrupt gossamer_via1_interrupts[NGOSSAMER_VIA1_INTERRUPTS] = {
	{ 0,	0,	0,	-1},			/* Cascade */
...
#define NGOSSAMER_INTERRUPTS 64

/* This structure is little-endian formatted... */

struct powermac_interrupt  gossamer_interrupts[NGOSSAMER_INTERRUPTS] = {
...
void configure_gossamer(void)
{
  heathrow_interrupts = (struct powermac_interrupt *) &gossamer_interrupts;
  heathrow_via1_interrupts = (struct powermac_interrupt *) &gossamer_via1_interrupts;
  
  nheathrow_interrupts = NGOSSAMER_INTERRUPTS;
  nheathrow_via_interrupts = NGOSSAMER_VIA1_INTERRUPTS;

  powermac_info.viaIRQ = NGOSSAMER_INTERRUPTS + 2;
}
