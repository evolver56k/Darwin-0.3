...
// void run_clock_test(clock_test_data *data)
//
...
// and the decrementer.  Return the number of ticks for both so the
// raw values for processor and bus speed can be calculated.
ENTRY(run_clock_test, TAG_NO_FRAME_USED)
...
L_again:
	...
	stb	r5,	CountHigh(r9)
	eieio
	li	r5,	0		; clear our scratch reg
	mtdec	r5			; clear the decrimenter
	isync
...
L_loop:
	...
	sync
	mfdec	r5			; save the raw decrimenter value
...
L_use_H1:
	...
	neg	r5,	r5		; r5 is the number of dec ticks
	stw	r5,	8(r3)		; save bus ticks
