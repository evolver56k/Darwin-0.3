...
#
#   Copyright:      (c) 1994-1998 by Apple Computer, Inc., all rights
#                   reserved.
#
...
#
#   At least through Mac OS 8, the bitmap versions of the fonts
#   Chicago, New York, Geneva, and Monaco do not implement the
#   full Roman character set; they only support Mac OS Roman character
...
#
#   WARNING: Sometime in 1998 the character set will likely be changed
#   to accommodate the EURO SIGN. This will most likely involve
#   changing the character at 0xDB from CURRENCY SIGN (U+00A4) to EURO
#   SIGN (probably U+20AC).
#
