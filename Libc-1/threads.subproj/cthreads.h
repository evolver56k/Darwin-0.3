...
extern int condition_wait_timeout(condition_t c, mutex_t m, unsigned int millisecs);
extern void condition_signal_timeout(condition_t c);
extern void condition_broadcast_timeout(condition_t c);
__DECLEND
