...
OBJC_EXPORT int log(int level, const char *format, ...);
OBJC_EXPORT int vlog(int level, const char *format, va_list ap);
OBJC_EXPORT volatile void panic(const char *reason);
