...
int isEqualPrototype (const void *info, const void *data1, const void *data2) {
...
uarith_t hashPrototype (const void *info, const void *data) {
...
uarith_t hashPtrStructKey (const void *info, const void *data) {
...
uarith_t hashStrStructKey (const void *info, const void *data) {
