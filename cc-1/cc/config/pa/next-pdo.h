...
#undef LINK_SPEC
#define LINK_SPEC "-u main -a shared_archive"

#undef LIB_SPEC
#define LIB_SPEC "%{p:-L/lib/libp }%{pg:%{!p:-L/lib/libp }}%{!nopdolib:-lpdo%s }-ldce -lm -lc_r -lc -lm"
...
#define NEXT_FRAMEWORKS_DEFAULT			\
    {"/opt/Apple/Local/Library/Frameworks", 0},	\
    {"/opt/Apple/Library/Frameworks", 0}, 
